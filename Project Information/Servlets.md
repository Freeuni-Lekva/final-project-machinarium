...
}, ...] - მიმდინარე თამაშის მონაწილეების სია.
* items: List of Items [] - არსებული ნივთების სია.
* status - თამაშის მდგომარეობა.

POST: გადაჰყავს სესიის მომხმარებლის თამაში (თუ იგი არის წამყვანი) მოცდის მდგომარეობიდან დაწყების მდგომარეობაზე.
...
Sent Attributes:
* car_id - დამატებული მანქანის სახელი.
...
Sent Attributes:
* car_id - არჩეული მანქანის ID.
* add: List[item_id - არჩეული ნივთის ID, ...] - დასამატებელი ნივთების სია.
* remove: List[item_id - არჩეული ნივთის ID, ...] - ამოსაღები ნივთების სია.
...
* offers: List[{
    user_name - შემოთავაზების ავტორის სახელი,
    order: Order - შეკვეთა.
}, ...] - სესიის მომხმარებლისთვის გაგზავნილი შემოთავაზებები.
